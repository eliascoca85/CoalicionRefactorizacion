-- Script para poblar la tabla verificadores con datos de ejemplo
...
(
  ...
  '["Verificación en tiempo real", "Base de datos de noticias falsas", "Reportes semanales"]',
  true
),
(
  'CheckiBot',
  ...
  '/logos/cheki.jpg',
  '["Verificación por WhatsApp", "Respuestas automáticas", "Enlaces a fuentes oficiales"]',
  true
),
(
  'Chequea Tu Voto',
  ...
  '["Datos oficiales", "Resultados electorales", "Normativa actualizada"]',
  true
),
(
  'Bolivia Verifica',
  ...
  '["Monitoreo en vivo", "Análisis estadístico", "Alertas tempranas"]',
  true
),
(
  'Olivia Verifica',
  ...
  '/logos/olivia.webp',
  '["Análisis de imágenes", "Verificación de videos", "Reportes instantáneos"]',
  true
),
(
  ...
  '/logos/OEPg.png',
  '["Integración fácil", "Documentación completa", "Acceso gratuito"]',
  true
);